...
def main(args):
    ...
    net = SCG(
        ...
        box_score_thresh=args.box_score_thresh, patch_size=args.patch_size, pose=args.pose, warp=args.warp, local_pose=args.local_pose, pose_cls=args.pose_cls
    )
